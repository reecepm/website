...
const Project: React.FC<Props> = ({ params }) => {
  ...
  return (
    <>
      <div className="flex h-full w-full flex-col gap-5 overflow-hidden pt-24 animate-in fade-in duration-1000 md:h-auto md:items-center md:justify-center md:gap-9 md:pt-0">
        ...
        <div className="grid h-full max-w-7xl grid-cols-5 gap-5 px-8 pb-16 md:h-auto md:gap-9">
